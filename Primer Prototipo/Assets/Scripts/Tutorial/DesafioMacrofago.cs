...
public class DesafioMacrofago : MonoBehaviour {
	...
	void Start () {
		...
		texto_Desafio.text += " "+PlayerPrefs.GetString ("name") + ", tienes 90 segundos para comerte y capturar  la mayor cantidad de patógenos, como mínimo debes fagocitar 3 virus y capturar 3. ";
	...
	public void cambiarPanelPrincipal(int num){
		...
		case 4:
			...
			Debug.Log("numerovirus i "+GameObject.Find("ManejadorVirus").GetComponent<ManejadorVirus>().i);
			Debug.Log("Numero virus"+ManejadorVirus.numeroVirus);
